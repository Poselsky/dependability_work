...
try {
    ...
    for ($j=0; $j < 0; $j++) {
        ...
        $infoCols = $blockComparer_four_units->compare_columns();
        ...
        VALUES ('0','4','row','$prob','50', '$randomRowOriginalStr', '$randomRowStr', '$randomRowIndex_four_units','$iterationsRows','$faultyUnitsRows' , '' )";
        $sqlCol = "INSERT INTO statistic (devVersion,numberOfUnits,comparisonType, probability_gen_syndrom,probability_x_replacement, syndromeOriginal, syndromeRandom, rowIndex, iterationToFaultyUnit, faultyUnits, description)
               VALUES ('0','4','col','$prob','50', '$randomRowOriginalStr', '$randomRowStr', '$randomRowIndex_four_units','$iterationsCols','$faultyUnitsCols' , '' )";
